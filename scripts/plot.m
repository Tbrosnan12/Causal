...
Export[pdfFileName,Show[ListPlot[PlottingPoints,PlotStyle->PointSize[0.00001],ImageSize->600],Plot[Re[W[\[Tau]]],{\[Tau],0,plotLength},PlotStyle->Red,PlotRange->{{0,plotLength},{-.2,.2}}],AxesOrigin->{0,0},PlotRange->{{0,plotLength},{-.2,.2}},AxesLabel -> {Style["|\[Tau]|", 16], Style["Re[W]", 16]}]];
